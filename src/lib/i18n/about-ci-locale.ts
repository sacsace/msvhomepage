...
export function aboutCiPageCopy(locale: SiteLocale): AboutCiPageCopy {
  return pickLocale(locale, {
    ko: {
      ...
      pageTitle: "CI 소개",
      pageLead: `${company.shortName} 심볼·워드마크·핵심 컬러를 웹·문서·프레젠테이션에 일관되게 쓰기 위한 공개 기준입니다.`,
    ...
    en: {
      ...
      pageTitle: "Brand & CI",
      pageLead: `Symbol, wordmark and core colours — a concise public reference for consistent use on the web, in documents and decks.`,
      symbolEyebrow: "Symbol",
    ...
    zh: {
      ...
      pageTitle: "CI 介绍",
      pageLead: `${company.shortName} 符号、横排组合与核心色在网站、文件与演示中的一致使用要点。`,
      symbolEyebrow: "符号",
      symbolTitle: "六点标识",
      symbolIntro:
