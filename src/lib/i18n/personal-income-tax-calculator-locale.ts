...
const ko: PersonalIncomeTaxCalculatorCopy = {
  metaTitle: "개인 소득세 계산기",
  metaDescription: `${company.shortName} — 인도 급여자 TDS 계산(누진·서차지·교육 cess) 참고 계산`,
  pageTitle: "개인 소득세 계산기",
  pageDescription:
    "세전 월급에 12개월을 곱한 연간 총소득으로 표준공제(₹75,000)를 반영해, 급여 TDS 계산 표와 같은 구조로 누진 소득세·서차지·교육 cess를 계산합니다. 법 개정·공제·87A 등으로 실제 부담과 다를 수 있습니다.",
  sectionRefCalc: "참고 계산",
  disclaimer:
    "본 도구는 참고용이며 법적·세무 자문을 대체하지 않습니다. 신규 과세체계(Section 115BAC)와 차이가 있을 수 있으니, 정확한 금액은 MSV와 상담 바랍니다.",
  ...
  labelStdDeduction: "표준공제 ₹75,000 적용 (항목 (ii))",
  hintStdDeduction: "급여·연금 등에 쓰이는 법정 표준공제입니다. 체크 해제 시 (ii)는 0으로 계산됩니다.",
  ...
  asideNetExplainAfter: "). PF·기타 공제는 포함하지 않은 참고치입니다.",
  ...
  rowStdHint: "연 ₹75,000 공제. 체크 해제 시 0입니다.",
  ...
  rowNetMonthlyHint: "세전 월급 − (vi) Monthly TDS. PF·HRA 등 다른 공제는 반영하지 않았습니다.",
...
const en: PersonalIncomeTaxCalculatorCopy = {
  metaTitle: "Personal income tax calculator",
  metaDescription: `${company.shortName} — India salary TDS reference (slabs, surcharge, education cess).`,
  pageTitle: "Personal income tax calculator",
  pageDescription:
    "We annualise pre-tax monthly salary (×12), apply the standard deduction (₹75,000) where selected, and compute progressive tax, surcharge and education cess in a salary TDS worksheet style. Actual liability may differ due to law changes, reliefs, section 87A, etc.",
  sectionRefCalc: "Reference calculation",
  disclaimer:
    "This tool is for illustration only and is not legal or tax advice. Results may differ from the new tax regime (Section 115BAC); confirm figures with MSV.",
  ...
  labelStdDeduction: "Apply standard deduction ₹75,000 (row (ii))",
  hintStdDeduction:
    "Statutory standard deduction for salary and pension. Uncheck to set row (ii) to zero.",
  ...
  asideNetExplainAfter: "). Excludes PF and other deductions.",
  ...
  rowStdTitle: "Standard deduction",
  rowStdHint: "₹75,000 per year. Zero if unchecked.",
  rowNetTaxableTitle: "Net taxable income ((i) − (ii))",
  ...
  rowNetMonthlyHint: "Pre-tax monthly salary − row (vi). PF, HRA and other items not included.",
  effectiveTdsTitle: "Effective TDS rate",
...
const zh: PersonalIncomeTaxCalculatorCopy = {
  ...
  pageTitle: "个人所得税计算器",
  pageDescription:
    "以税前月薪乘以 12 得到年度总收入，并在勾选时适用标准扣除 ₹75,000，按工资 TDS 表结构计算累进所得税、附加费与教育附加费。法律修订、其他扣除或 87A 等可能导致实际税负不同。",
  sectionRefCalc: "参考计算",
  disclaimer:
    "本工具仅供示意，不构成法律或税务意见。与新税制（Section 115BAC）可能存在差异，具体金额请与 MSV 确认。",
  ...
  labelStdDeduction: "适用标准扣除 ₹75,000（第 (ii) 项）",
  hintStdDeduction: "适用于工资、养老金等的法定标准扣除。取消勾选则第 (ii) 项按 0 计算。",
  ...
  asideNetExplainAfter: "）。不含公积金等其他扣除。",
  ...
  rowNetMonthlyHint: "税前月薪 − 第 (vi) 项。不含 PF、HRA 等其他项目。",
