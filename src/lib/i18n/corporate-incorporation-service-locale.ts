  ...
  return pickLocale(locale, {
    ko: {
      ...
      supportItems: [
        ...
        "설립 후 정관·이사회·주주 결의 등 기본 거버넌스 구조 점검(회계·세무 팀과 연계)",
      ],
      valuePropositionTitle: "왜 MSV인가",
      valueProposition: `${company.shortName}는 회계·세무·법인 운영 실무를 기반으로 설립 이후 실제 운영 단계까지 고려하여 구조를 설계합니다.`,
      step1Eyebrow: "Step 1",
      ...
      timelineItems: [
        ...
        {
          label: "자본금 송금·해외투자금 신고 및 RBI 보고",
          value: "COI 발급일로부터 60일 이내 송금, 보고·검토 일정은 건별 상이(참고: 10~15 근무일 전후)",
        },
      ...
      step5Items: [
        ...
        "- 최소 1인의 인도 거주 이사(Resident Director, 통상 연간 182일 이상 인도 체류 요건)가 필요합니다.",
      ],
      step6Eyebrow: "Step 6",
      step6Title: "자본금 및 예상 등록 비용 예시",
      step6Intro:
        "아래 원화는 1 INR ≈ 16 KRW로 단순 환산한 참고치입니다. 환율은 예시 기준이며 실제 송금 시점에 따라 달라질 수 있습니다.",
      tableCapitalInr: "자본금 (INR)",
      tableCapitalKrw: "자본금 한화 (KRW)",
      tableGovFeeInr: "예상 등록 비용 (INR)",
      step6Footnote:
      ...
      step7Items: [
        ...
        "- 현지 등록 주소(Registered Office)가 필요합니다.",
      ],
      closingNote:
    ...
    en: {
      ...
      incorporationSteps: [
        ...
        "Director PAN (income tax number), when required",
        ...
        "Capital remittance, foreign investment reporting and RBI filing steps",
        "Business commencement steps",
        "Share issuance and Demat account linkage",
        "GST registration",
      ...
      factoryFollowUp: [
        ...
        "Environmental, fire-safety and Factory Licence-related permits",
      ...
      timelineItems: [
        ...
        {
          label: "Capital remittance, reporting and RBI filings",
          value: "Remit within 60 days of COI; RBI timelines vary by case (often around 10–15 working days)",
        },
      ...
      step5Items: [
        ...
        "- At least one India resident director is required (typically 182+ days in India per year).",
      ],
      step6Eyebrow: "Step 6",
      step6Title: "Illustrative capital and registration costs",
      step6Intro:
        "KRW amounts below use a simple illustrative rate of 1 INR ≈ 16 KRW. Actual rates depend on the remittance date.",
      tableCapitalInr: "Share capital (INR)",
      tableCapitalKrw: "Share capital (KRW, indicative)",
      tableGovFeeInr: "Indicative registration costs (INR)",
      step6Footnote:
      ...
      scheduleChart: {
        ...
        phaseLabel: {
          ...
          rbiFdi: "Foreign investment reporting and RBI filings",
    ...
    zh: {
      ...
      supportItems: [
        ...
        "章程、董事会与股东决议等基本治理结构（与会计·税务团队协同）",
      ],
      valuePropositionTitle: "为何选择 MSV",
      valueProposition: `${company.shortName} 以会计、税务与法人运营实务为基础，在设立阶段即考虑设立后的实际运营，协助设计整体结构。`,
      step1Eyebrow: "Step 1",
      ...
      timelineItems: [
        ...
        { label: "资本金汇入·外商投资申报及 RBI 报告", value: "自 COI 起 60 日内汇入；RBI 节奏因案而异（参考约 10–15 个工作日）" },
      ...
      step5Items: [
        "- 至少两名登记董事及股东（可为个人或法人）。",
        "- 至少一名印度居住董事（Resident Director，通常每年在印度居住 182 日以上）。",
      ],
      step6Eyebrow: "Step 6",
      step6Title: "资本金与预计登记费用示例",
      step6Intro: "下列韩元金额为按 1 INR ≈ 16 KRW 的示意换算，仅供参考。实际汇率以汇款时点为准。",
      tableCapitalInr: "资本金（INR）",
      tableCapitalKrw: "资本金（KRW，示意）",
      tableGovFeeInr: "预计登记费用（INR）",
      step6Footnote: "费用因注册所在邦及股份数量而异，最终以主管 RoC/邦政府核定为准。",
      step7Eyebrow: "Step 7",
      step7Title: "注册地址要求",
      step7Items: ["- 名称核准后约两周内需确定。", "- 须具备当地注册地址（Registered Office）。"],
      closingNote:
